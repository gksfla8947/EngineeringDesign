...
#define _DUTY_MIN 554 // servo full clockwise position (0 degree)
#define _DUTY_NEU 1476 // servo neutral position (90 degree)
#define _DUTY_MAX 2398 // servo full counterclockwise position (180 degree)
...
// get a distance reading from the USS
  ...
  if(dist_raw == 0.0) dist_raw = dist_prev;
...
// add your code here!
  if(dist_raw <= dist_min) {
    ...
    myservo.writeMicroseconds(_DUTY_MIN + (10.24 * (dist_ema - 180)));
  }
